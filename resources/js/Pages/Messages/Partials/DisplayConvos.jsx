...
function DisplayConvos({
    ...
    const conversationsWithNames = conversations.map((convo) => {
        ...
        if (index >= 0) {
            console.log("Most recent msg: " + messagesByConversation[convo.id].messages[index].body); //should b the most recent msg in the conversation
        }
                    ...
                    <li key={convo.id}>
                        ...
                        >
                            <div className="flex">
                                ...
                                |
                                <span className="text-blue-500 opacity-60">
                                    {new Date(convo.timeOfMsg).toLocaleString()}{" "}
                                </span>
                            </div>
                        </a>
                    </li>
